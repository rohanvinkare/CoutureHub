...
//   // Capture the category from the URL (defined in App.js as /categories/:category)
...
//   /* 1. Load available categories for the dropdown */
//   useEffect(() => {
//     getCategories().then(setCategories)
//   }, [])

//   /* 2. SYNC: Update filter if the URL parameter changes (Drill-down behavior) */
//   useEffect(() => {
//     setFilterCategory(category || '')
//     setSearch('') // Clear search when switching categories via URL
//     setPage(0)
//   }, [category])

//   /* 3. Search Override: Typing in search clears the category filter */
//   useEffect(() => {
//     if (debouncedSearch) {
//       setFilterCategory('')
//       setPage(0)
...
//   /* 4. Reset page when filters change manually */
//   useEffect(() => {
//     setPage(0)
//   }, [sort, filterCategory])
...
//         // A. Fetch Data (Filtered or All)
//         if (filterCategory) {
//           // If a category is selected (via URL or Dropdown), fetch specific
...
//         // B. Search Filtering (Client-side)
//         if (debouncedSearch) {
...
//           <img src={EMPTY_IMAGE} alt="No products" className="w-48 opacity-50 mb-4" />
...
//                 <tr>
//                   <th className="pl-6 pr-3 py-4 w-[60px]">SKU</th>
//                   <th className="px-3 py-4 w-[350px]">Product</th>
...
//                   <th className="pr-6 pl-3 py-4 text-right">Action</th>
//                 </tr>
//               </thead>
...
//                         <div className="flex items-center gap-1 text-gray-400 mt-2 font-mono text-xs">
...
//                             <span className={`text-sm font-semibold ${p.stock < LOW_STOCK_THRESHOLD ? 'text-red-600' : 'text-gray-700'}`}>
//                               {p.stock}
//                             </span>
...
//                       {/* Price (Calculated vs Original) */}
//                       <td className="px-3 py-4 text-right align-middle">
//                         <div className="flex flex-col items-end gap-0.5">
//                           <span className="font-bold text-gray-900">${finalPrice}</span>
//                           {p.discountPercentage > 0 && (
//                             <div className="flex items-center gap-1.5 text-xs">
//                               <span className="text-gray-400 line-through decoration-gray-400">${p.price}</span>
//                               <span className="text-emerald-600 font-medium bg-emerald-50 px-1 rounded">-{Math.round(p.discountPercentage)}%</span>
//                             </div>
//                           )}
//                         </div>
//                       </td>
...
//                           <Star className={`h-4 w-4 ${p.rating >= 4 ? 'fill-amber-400 text-amber-400' : 'fill-gray-200 text-gray-300'}`} />
